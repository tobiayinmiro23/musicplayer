  ...
  return (
    <div className="App">
      <div className={DarkMode ? "containerDark" : "container"}>
        ...
        {page === 'nowPlaying' && <NowPlaying isPlaying={isPlaying} setisPlaying={setisPlaying} playButton={playButton} pauseButton={pauseButton} plaiyingSongIdBeforePlaynext={plaiyingSongIdBeforePlaynext} setplaiyingSongIdBeforePlaynext={setplaiyingSongIdBeforePlaynext} playnextOn={playnextOn} repeatOnButton={repeatOnButton} repeatOfButton={repeatOfButton} shuffleOn={shuffleOn} setshuffleOn={setshuffleOn} repeatOn={repeatOn} setrepeatOn={setrepeatOn} setplaynextOn={setplaynextOn} page={setpage} setplayNextSongIndex={setplayNextSongIndex} playNextSongIndex={playNextSongIndex} playnext={playnext} handlePlayNext={handlePlayNext} from={from} handleAudiosCurrentTime={handleAudiosCurrentTime} audiosCurrentTime={audiosCurrentTime}  setfirstPlayListSongId={setfirstPlayListSongId} songs={songs} DarkMode={DarkMode} HandleNowPlaying={handleNowPlaying}  handleAllSongs={handleAllSongs} musicInfo={nowPlaying}/>}
      </div>
    </div>
  );
}
